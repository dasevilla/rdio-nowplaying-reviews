...
module.exports = React.createClass({displayName: "exports",
  render: function() {
    return (
      React.createElement(BootstrapRow, null, 
...
},{"./BootStrapColumn":158,"./BootstrapRow":159,"react":157}],161:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    ...
    if (R.authenticated()) {
      mainClass = React.createElement(ReviewBox, {musikkiAppId: "eb09bd0c88d0a0d1b6ce4811f4e64729", musikkiAppKey: "c7261efcb5a83bc4ecf1417ffc4350ea"});
    } else {
      console.log('Not authenticated');
      mainClass = (
        React.createElement(BootstrapRow, null, 
          React.createElement(BootStrapColumn, {className: "col-md-12"}, 
            React.createElement(RdioAuthCheck, null)
          )
        )
      )
    }
    ...
    return (
      React.createElement("div", null, 
        mainClass, 
        React.createElement(NowPlayingFooter, null)
      )
    )
  }
});

},{"./BootStrapColumn":158,"./BootstrapRow":159,"./NowPlayingFooter":160,"./RdioAuthCheck":162,"./ReviewBox":163,"react":157}],162:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    if (!this.state.isAuthenticated) {
      return (
        React.createElement("p", null, 
          React.createElement("button", {className: "btn btn-primary btn-lg", onClick: this.handleAuthenticate}, "Sign in with Rdio")
        )
      )
    } else {
      return (
    ...
    if (this.state.release.title) {
      return (
        React.createElement("div", {className: "reviewBox"}, 
          React.createElement(BootstrapRow, null, 
            React.createElement(BootStrapColumn, {className: "col-md-12"}, 
              React.createElement(ReviewBoxTitle, {release: this.state.release})
            )
          ), 
          React.createElement(ReviewList, {reviews: this.state.reviews})
        )
      );
    } else {
      return (
...
},{"./BootStrapColumn":158,"./BootstrapRow":159,"./ReviewBoxTitle":164,"./ReviewList":166,"jquery":2,"react":157}],164:[function(require,module,exports){
var React = require('react');

module.exports = React.createClass({displayName: "exports",
  render: function() {
    if (this.props.release.title) {
      return React.createElement("h2", null, "Reviews of ", React.createElement("em", null, this.props.release.title))
    } else {
      return React.createElement("h2", null, "Unable to find on Musikki")
    }
  }
});
        ...
        React.createElement(BootStrapColumn, {className: "col-md-12"}, 
          React.createElement("blockquote", null, 
            ...
            React.createElement("footer", null, 
              React.createElement("a", {href: this.props.review.url, target: "_blank"}, 
                React.createElement("img", {src: this.props.review.source.avatar, height: "20"})
              ), " (", React.createElement("span", {className: "rating"}, this.props.review.rating.value, "/", this.props.review.rating.scale), ")"
            )
          )
        )
      )
...
},{"./BootStrapColumn":158,"./BootstrapRow":159,"react":157}],166:[function(require,module,exports){
var React = require('react');
  ...
  render: function() {
    if (this.props.reviews.length) {
      var reviewItems = this.props.reviews.map(function(review){
        return (
          React.createElement(ReviewItem, {key: review.mkid, review: review})
        )
      })
      return (
        React.createElement("div", {className: "reviewList"}, 
          reviewItems
        )
      )
    } else {
...
},{"./ReviewItem":165,"react":157}],167:[function(require,module,exports){
var React = require('react');
var NowPlayingReviews = require('./NowPlayingReviews');

R.ready(function() {
  React.render(
    React.createElement(NowPlayingReviews, null),
    document.getElementById('content')
  );
});

},{"./NowPlayingReviews":161,"react":157}]},{},[167]);
